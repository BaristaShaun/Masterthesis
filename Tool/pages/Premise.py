...
def app():
    ...
    with tab1:
        ...
        if selected_datasets:
            ...
            columns = first_df.columns[1:]  # Exclude 'Year'
    ...
    with tab2:
        ...
        if scenario_dfs:
            ...
            for i, fuel in enumerate(fuel_columns):
                ...
                # 🔽 기준선 라벨 추가
                ax.text(2021, 4.25, "Jet Fuel Baseline", fontsize=6, color="gray")
                ax.text(2021, 1.45, "RED III Target", fontsize=6, color="black")
                ax.set_title(style["label"], fontsize=10, color=style["color"])
                ax.set_ylim(ymin, ymax)
                ax.set_xlabel("Year", fontsize=8)
                ax.set_ylabel("kg CO₂-eq/kg fuel", fontsize=8)
